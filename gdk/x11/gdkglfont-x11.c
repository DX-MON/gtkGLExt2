...
/*
 * Modified by Richard Mant 2010. See AUTHORS and ChangeLog for a sumary
 * of the changes made here.
 *
 * The file is practically a complete rewrite of the old PangoX code, but
 * does need a little cleaning up - example, do not know if pangoft2.h is
 * needed any more.
 */
...
/* Use of uint64_t to future-proof the code in case someone wants to call
 * with a ridiculously big font-size..
 */
...
/* Flips the bitmap in the y axis */
...
/* Flips the bitmap in the x axis */
...
/* This being a seperate funciton may nolonger be neccasery. */
static PangoFont *
